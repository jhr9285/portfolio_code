...
<div class="card-body">		    
	...
	<tbody>
		...
		<tr>
			<%-- <td>${allList.rn}</td> --%>
			<td>${allList.mno}</td>
			<td><a href="/easyfit/allClientGet?mno=${allList.mno}&tno=<sec:authentication property="principal.trainerVO.tno"/>">${allList.mname}</a></td>
			<td>${allList.mtel}</td>
...
<div class="row">
	<div class="col-lg-12" align="center">
		<form id='searchForm' action="/easyfit/allClientList" method='get' class='form-inline justify-content-center'>	
			...
			<div class="card-body py3">
				<div class="d-sm-flex justify-content-center align-items-center mb-4">
					...
					<input type="hidden" name="tno" class='custom-select-sm form-control form-control-sm ml-2' value="<sec:authentication property="principal.trainerVO.tno"/>">
					<div class="ml-2">
					...
					<div class="ml-2">
						<button type="button" class="btn btn-primary custom-select-sm btn-width" onclick="location.href='/easyfit/allClientRegister'">회원등록</button>
					</div>
